            ...
            var row = new TRow
                {
                    ...
                    FormattedPrice = baseContent.Price.AsFormattedCurrency(baseContent.StoreId),
                    Price = baseContent.Price,
                    SalePrice = baseContent.SalePrice,
                    FormattedSalePrice = baseContent.SalePrice.AsFormattedCurrency(baseContent.StoreId),
