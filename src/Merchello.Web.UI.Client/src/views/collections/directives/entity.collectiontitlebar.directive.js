angular.module('merchello.directives').directive('entityCollectionTitleBar', function ($compile, $routeParams, localizationService, entityCollectionResource, entityCollectionDisplayBuilder, entityCollectionProviderDisplayBuilder) {
    return {
        restrict: 'E',
        replace: true,
        scope: {
            ...
            function loadCollection() {
                if (scope.collectionKey === 'manage' || scope.collectionKey === '' || scope.collectionKey === undefined) {
                    ...
                    entityCollectionResource.getByKey(scope.collectionKey).then(function (collection) {
                        ...
                        entityCollectionResource.getEntityCollectionProviders($routeParams.storeId).then(function (results) {//TODOMS
