angular.module('merchello.directives').directive('customerItemCacheTable',
    ['$q', '$routeParams', '$location', 'localizationService', 'notificationsService', 'dialogService', 'settingsResource', 'customerResource', 'backOfficeCheckoutResource',
        function ($q, $routeParams, $location, localizationService, notificationsService, dialogService, settingsResource, customerResource, backOfficeCheckoutResource) {
                ...
                link: function (scope, elm, attr) {
                    ...
                    function processCheckout(dialogData) {
                        ...
                        backOfficeCheckoutResource
                            ...
                            .then(function (inv) {
                                $location.url(baseUrl + inv.key + '/store/' + $routeParams.storeId, true);
                            }, function (msg) {
