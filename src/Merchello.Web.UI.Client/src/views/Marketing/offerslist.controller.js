...
angular.module('merchello').controller('Merchello.Backoffice.OffersListController',
    ['$scope', '$q', '$routeParams', '$location', '$filter', 'notificationsService', 'localizationService', 'settingsResource', 'marketingResource', 'merchelloTabsFactory',
        'settingDisplayBuilder', 'offerProviderDisplayBuilder', 'offerSettingsDisplayBuilder',
        function ($scope, $q, $routeParams, $location, $filter, notificationsService, localizationService, settingsResource, marketingResource, merchelloTabsFactory,
            settingDisplayBuilder, offerProviderDisplayBuilder, offerSettingsDisplayBuilder) {
            ...
            function getEditUrl(offer) {
                ...
                return url + '/' + provider.editorUrl(offer.key + '/store/' + $routeParams.storeId);
            }
