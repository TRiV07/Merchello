angular.module('merchello').controller('Merchello.Backoffice.TaxationProvidersController',
    ['$scope', '$routeParams', '$timeout', 'settingsResource', 'notificationsService', 'dialogService', 'taxationGatewayProviderResource', 'dialogDataFactory', 'merchelloTabsFactory',
        ...
        function ($scope, $routeParams, $timeout, settingsResource, notificationsService, dialogService, taxationGatewayProviderResource, dialogDataFactory, merchelloTabsFactory,
            settingDisplayBuilder, countryDisplayBuilder, taxCountryDisplayBuilder,
            gatewayResourceDisplayBuilder, taxationGatewayProviderDisplayBuilder, taxMethodDisplayBuilder) {
            ...
            function loadAllTaxationGatewayProviders() {
                ...
                var promiseAllProviders = taxationGatewayProviderResource.getAllGatewayProviders($routeParams.storeId);
            ...
            function loadAvailableCountriesWithoutMethod(taxationGatewayProvider, noTaxProvider) {
                var promiseGwResources = taxationGatewayProviderResource.getGatewayResources(taxationGatewayProvider.key, taxationGatewayProvider.storeId);
            ...
            function loadTaxMethods(taxationGatewayProvider) {
                ...
                var promiseGwResources = taxationGatewayProviderResource.getTaxationProviderTaxMethods(taxationGatewayProvider.key, taxationGatewayProvider.storeId);
                ...
                angular.forEach($scope.availableCountries, function (country) {
                    if (country.provider.key === -1) {
                        ...
                        if (country.taxMethod.providerKey !== country.provider.key) {
                            ...
                            country.taxMethod.storeId = $routeParams.storeId;
