angular.module('merchello').controller('Merchello.PropertyEditors.MerchelloProductCollectionPickerController',
    ['$scope', '$routeParams', '$q', 'dialogService', 'entityCollectionResource', 'entityCollectionDisplayBuilder',
        function ($scope, $routeParams, $q, dialogService, entityCollectionResource, entityCollectionDisplayBuilder) {
            ...
            function openCollectionSelectionDialog() {
                ...
                dialogData.contentId = $routeParams.id;
