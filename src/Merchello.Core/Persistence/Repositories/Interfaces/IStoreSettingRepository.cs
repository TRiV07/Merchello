namespace Merchello.Core.Persistence.Repositories
{
    ...
    internal interface IStoreSettingRepository : IMSRepository<Guid, IStoreSetting>
    {
        ...
        int GetNextInvoiceNumber(Guid storeSettingKey, int storeId, Func<int> validate, int invoicesCount = 1);
        ...
        int GetNextOrderNumber(Guid storeSettingKey, int storeId, Func<int> validate, int ordersCount = 1);
        ...
        /// <returns>The next order number</returns>
        int GetNextShipmentNumber(Guid storeSettingKey, int storeId, Func<int> validate, int shipmentsCount = 1);
